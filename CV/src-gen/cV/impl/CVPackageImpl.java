...
public class CVPackageImpl extends EPackageImpl implements CVPackage {
	...
	public static CVPackage init() {
		if (isInited)
			return (CVPackage) EPackage.Registry.INSTANCE.getEPackage(CVPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredCVPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		CVPackageImpl theCVPackage = registeredCVPackage instanceof CVPackageImpl ? (CVPackageImpl) registeredCVPackage
				: new CVPackageImpl();
		...
		EValidator.Registry.INSTANCE.put(theCVPackage, new EValidator.Descriptor() {
	 ...
	 * @generated
	 */
	public EOperation getCV__Obligatory_personal_data_section__DiagnosticChain_Map() {
		return cvEClass.getEOperations().get(1);
	}
	 ...
	 * @generated
	 */
	public EOperation getCV__At_most_one_education_section__DiagnosticChain_Map() {
		return cvEClass.getEOperations().get(2);
	}
	 ...
	 * @generated
	 */
	public EOperation getCV__At_most_one_work_experience_section__DiagnosticChain_Map() {
		return cvEClass.getEOperations().get(3);
	}
	 ...
	 * @generated
	 */
	public EOperation getBibliographicEntry__Check_year__DiagnosticChain_Map() {
		return bibliographicEntryEClass.getEOperations().get(0);
	}
	 ...
	 * @generated
	 */
	public EOperation getTable__Rows_same_length_as_header__DiagnosticChain_Map() {
	 ...
	 * @generated
	 */
	public EOperation getSkillEntry__Limit_value__DiagnosticChain_Map() {
		return skillEntryEClass.getEOperations().get(0);
	}
	...
	public void createPackageContents() {
		...
		createEOperation(cvEClass, CV___AT_MOST_ONE_WORK_EXPERIENCE_SECTION__DIAGNOSTICCHAIN_MAP);
		...
		createEOperation(tableEClass, TABLE___ROWS_SAME_LENGTH_AS_HEADER__DIAGNOSTICCHAIN_MAP);
		...
		createEOperation(skillEntryEClass, SKILL_ENTRY___LIMIT_VALUE__DIAGNOSTICCHAIN_MAP);
	}
	...
	public void initializePackageContents() {
		...
		op = initEOperation(getCV__Obligatory_personal_data_section__DiagnosticChain_Map(), ecorePackage.getEBoolean(),
				"obligatory_personal_data_section", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = initEOperation(getCV__At_most_one_education_section__DiagnosticChain_Map(), ecorePackage.getEBoolean(),
				"at_most_one_education_section", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = initEOperation(getCV__At_most_one_work_experience_section__DiagnosticChain_Map(),
				ecorePackage.getEBoolean(), "at_most_one_work_experience_section", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		initEAttribute(getField_Title(), ecorePackage.getEString(), "title", null, 0, 1, Field.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getField_Items(), this.getItem(), null, "items", null, 0, -1, Field.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		...
		initEAttribute(getText_Value(), ecorePackage.getEString(), "value", null, 0, 1, Text.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getImage_Value(), ecorePackage.getEString(), "value", null, 0, 1, Image.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getImage_Width(), ecorePackage.getEInt(), "width", null, 1, 1, Image.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getImage_Height(), ecorePackage.getEInt(), "height", null, 1, 1, Image.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(bibliographicEntryEClass, BibliographicEntry.class, "BibliographicEntry", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getBibliographicEntry_Author(), ecorePackage.getEString(), "author", null, 0, 1,
				BibliographicEntry.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getBibliographicEntry_Year(), ecorePackage.getEInt(), "year", null, 1, 1,
				BibliographicEntry.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		...
		op = initEOperation(getTable__Rows_same_length_as_header__DiagnosticChain_Map(), ecorePackage.getEBoolean(),
				"rows_same_length_as_header", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		initEReference(getTableRow_Items(), this.getItem(), null, "items", null, 0, -1, TableRow.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		...
		initEClass(educationEClass, Education.class, "Education", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getEducation_EducationEntries(), this.getEducationEntry(), null, "educationEntries", null, 1, -1,
				Education.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(jobEntryEClass, JobEntry.class, "JobEntry", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getJobEntry_Title(), ecorePackage.getEString(), "title", null, 1, 1, JobEntry.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(educationEntryEClass, EducationEntry.class, "EducationEntry", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getEducationEntry_Level(), ecorePackage.getEString(), "level", null, 1, 1, EducationEntry.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEducationEntry_School(), ecorePackage.getEString(), "school", null, 1, 1,
		...
		initEClass(workExperienceEClass, WorkExperience.class, "WorkExperience", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getWorkExperience_JobEntries(), this.getJobEntry(), null, "jobEntries", null, 1, -1,
				WorkExperience.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(skillsEClass, Skills.class, "Skills", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getSkills_Title(), ecorePackage.getEString(), "title", null, 0, 1, Skills.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSkills_Skills(), this.getSkillEntry(), null, "skills", null, 1, -1, Skills.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(skillEntryEClass, SkillEntry.class, "SkillEntry", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getSkillEntry_Title(), ecorePackage.getEString(), "title", null, 1, 1, SkillEntry.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSkillEntry_SkillValue(), ecorePackage.getEInt(), "skillValue", null, 1, 1, SkillEntry.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		op = initEOperation(getSkillEntry__Limit_value__DiagnosticChain_Map(), ecorePackage.getEBoolean(),
				"limit_value", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation(cvEClass, source, new String[] { "constraints", "at_most_one_work_experience_section" });
		addAnnotation(bibliographicEntryEClass, source, new String[] { "constraints", "check_year" });
		addAnnotation(tableEClass, source, new String[] { "constraints", "rows_same_length_as_header" });
		addAnnotation(skillEntryEClass, source, new String[] { "constraints", "limit_value" });
	}
	...
	protected void createPivotAnnotations() {
		...
		addAnnotation(getCV__Obligatory_contacts_section__DiagnosticChain_Map(), source,
				new String[] { "body", "Contacts.allInstances()->size() = 1" });
		addAnnotation(getCV__Obligatory_personal_data_section__DiagnosticChain_Map(), source,
				new String[] { "body", "PersonalData.allInstances()->size() = 1" });
		addAnnotation(getCV__At_most_one_education_section__DiagnosticChain_Map(), source,
				new String[] { "body", "Education.allInstances()->size() <= 1" });
		addAnnotation(getCV__At_most_one_work_experience_section__DiagnosticChain_Map(), source,
				new String[] { "body", "WorkExperience.allInstances()->size() <= 1" });
		addAnnotation(getBibliographicEntry__Check_year__DiagnosticChain_Map(), source,
				new String[] { "body", "self.year > 0" });
		addAnnotation(getTable__Rows_same_length_as_header__DiagnosticChain_Map(), source, new String[] { "body",
				"self.header->size() = 1 implies self.rows->forAll(r | r.items->size() = self.header->size())" });
		addAnnotation(getSkillEntry__Limit_value__DiagnosticChain_Map(), source,
				new String[] { "body", "self.skillValue >= 1 and self.skillValue <= 5" });
	}
