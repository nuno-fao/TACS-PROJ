...
public interface CVPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int CV___OBLIGATORY_CONTACTS_SECTION__DIAGNOSTICCHAIN_MAP = 0;

	/**
	 * The operation id for the '<em>Obligatory personal data section</em>' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int CV___OBLIGATORY_PERSONAL_DATA_SECTION__DIAGNOSTICCHAIN_MAP = 1;

	/**
	 * The operation id for the '<em>At most one education section</em>' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int CV___AT_MOST_ONE_EDUCATION_SECTION__DIAGNOSTICCHAIN_MAP = 2;

	/**
	 * The operation id for the '<em>At most one work experience section</em>' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int CV___AT_MOST_ONE_WORK_EXPERIENCE_SECTION__DIAGNOSTICCHAIN_MAP = 3;
	 ...
	 * @ordered
	 */
	int BIBLIOGRAPHIC_ENTRY___CHECK_YEAR__DIAGNOSTICCHAIN_MAP = ITEM_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int BIBLIOGRAPHIC_ENTRY_OPERATION_COUNT = ITEM_OPERATION_COUNT + 1;
	...
	/**
	 * The operation id for the '<em>Rows same length as header</em>' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int TABLE___ROWS_SAME_LENGTH_AS_HEADER__DIAGNOSTICCHAIN_MAP = 0;
	...
	/**
	 * The operation id for the '<em>Limit value</em>' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int SKILL_ENTRY___LIMIT_VALUE__DIAGNOSTICCHAIN_MAP = ITEM_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int SKILL_ENTRY_OPERATION_COUNT = ITEM_OPERATION_COUNT + 1;
	 ...
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Obligatory contacts section</em>' operation.
	 * @see cV.CV#obligatory_contacts_section(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 */
	EOperation getCV__Obligatory_contacts_section__DiagnosticChain_Map();

	/**
	 * Returns the meta object for the '{@link cV.CV#obligatory_personal_data_section(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Obligatory personal data section</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Obligatory personal data section</em>' operation.
	 * @see cV.CV#obligatory_personal_data_section(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 */
	EOperation getCV__Obligatory_personal_data_section__DiagnosticChain_Map();

	/**
	 * Returns the meta object for the '{@link cV.CV#at_most_one_education_section(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>At most one education section</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>At most one education section</em>' operation.
	 * @see cV.CV#at_most_one_education_section(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 */
	EOperation getCV__At_most_one_education_section__DiagnosticChain_Map();

	/**
	 * Returns the meta object for the '{@link cV.CV#at_most_one_work_experience_section(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>At most one work experience section</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>At most one work experience section</em>' operation.
	 * @see cV.CV#at_most_one_work_experience_section(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 */
	EOperation getCV__At_most_one_work_experience_section__DiagnosticChain_Map();
	 ...
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Check year</em>' operation.
	 * @see cV.BibliographicEntry#check_year(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 */
	EOperation getBibliographicEntry__Check_year__DiagnosticChain_Map();
	...
	/**
	 * Returns the meta object for the '{@link cV.Table#rows_same_length_as_header(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Rows same length as header</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Rows same length as header</em>' operation.
	 * @see cV.Table#rows_same_length_as_header(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 */
	EOperation getTable__Rows_same_length_as_header__DiagnosticChain_Map();
	...
	/**
	 * Returns the meta object for the '{@link cV.SkillEntry#limit_value(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Limit value</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Limit value</em>' operation.
	 * @see cV.SkillEntry#limit_value(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 */
	EOperation getSkillEntry__Limit_value__DiagnosticChain_Map();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EOperation CV___OBLIGATORY_CONTACTS_SECTION__DIAGNOSTICCHAIN_MAP = eINSTANCE
				.getCV__Obligatory_contacts_section__DiagnosticChain_Map();

		/**
		 * The meta object literal for the '<em><b>Obligatory personal data section</b></em>' operation.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EOperation CV___OBLIGATORY_PERSONAL_DATA_SECTION__DIAGNOSTICCHAIN_MAP = eINSTANCE
				.getCV__Obligatory_personal_data_section__DiagnosticChain_Map();

		/**
		 * The meta object literal for the '<em><b>At most one education section</b></em>' operation.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EOperation CV___AT_MOST_ONE_EDUCATION_SECTION__DIAGNOSTICCHAIN_MAP = eINSTANCE
				.getCV__At_most_one_education_section__DiagnosticChain_Map();

		/**
		 * The meta object literal for the '<em><b>At most one work experience section</b></em>' operation.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EOperation CV___AT_MOST_ONE_WORK_EXPERIENCE_SECTION__DIAGNOSTICCHAIN_MAP = eINSTANCE
				.getCV__At_most_one_work_experience_section__DiagnosticChain_Map();
		 ...
		 * @generated
		 */
		EOperation BIBLIOGRAPHIC_ENTRY___CHECK_YEAR__DIAGNOSTICCHAIN_MAP = eINSTANCE
				.getBibliographicEntry__Check_year__DiagnosticChain_Map();
		...
		/**
		 * The meta object literal for the '<em><b>Rows same length as header</b></em>' operation.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EOperation TABLE___ROWS_SAME_LENGTH_AS_HEADER__DIAGNOSTICCHAIN_MAP = eINSTANCE
				.getTable__Rows_same_length_as_header__DiagnosticChain_Map();
		...
		/**
		 * The meta object literal for the '<em><b>Limit value</b></em>' operation.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EOperation SKILL_ENTRY___LIMIT_VALUE__DIAGNOSTICCHAIN_MAP = eINSTANCE
				.getSkillEntry__Limit_value__DiagnosticChain_Map();
