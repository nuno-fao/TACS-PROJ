	...
	protected void addFieldPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Table_field_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Table_field_feature", "_UI_Table_type"),
				 CVPackage.Literals.TABLE__FIELD,
				 true,
				 false,
				 true,
				 null,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CVPackage.Literals.TABLE__ROWS,
				 CVFactory.eINSTANCE.createTableRow()));
	}
