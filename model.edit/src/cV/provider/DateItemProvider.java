	...
	protected void addEnding_datePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Date_ending_date_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Date_ending_date_feature", "_UI_Date_type"),
				 CVPackage.Literals.DATE__ENDING_DATE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
