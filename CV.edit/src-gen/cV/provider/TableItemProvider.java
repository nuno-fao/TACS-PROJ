...
/**
 * This is the item provider adapter for a {@link cV.Table} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TableItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addHeaderPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Table_header_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Table_header_feature", "_UI_Table_type"),
						CVPackage.Literals.TABLE__HEADER, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CVPackage.Literals.TABLE__FIELD);
			childrenFeatures.add(CVPackage.Literals.TABLE__ROWS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(CVPackage.Literals.TABLE__FIELD, CVFactory.eINSTANCE.createField()));

		newChildDescriptors
				.add(createChildParameter(CVPackage.Literals.TABLE__ROWS, CVFactory.eINSTANCE.createTableRow()));
	}
