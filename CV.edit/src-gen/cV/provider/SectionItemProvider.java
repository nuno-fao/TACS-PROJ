...
/**
 * This is the item provider adapter for a {@link cV.Section} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SectionItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addHeaderPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Section_header_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Section_header_feature",
								"_UI_Section_type"),
						CVPackage.Literals.SECTION__HEADER, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CVPackage.Literals.SECTION__FIELDS);
		}
	...
	public String getText(Object object) {
		String label = ((Section) object).getHeader();
	...
	public void notifyChanged(Notification notification) {
		...
		case CVPackage.SECTION__HEADER:
			fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
			return;
		case CVPackage.SECTION__FIELDS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(CVPackage.Literals.SECTION__FIELDS, CVFactory.eINSTANCE.createField()));
	}
