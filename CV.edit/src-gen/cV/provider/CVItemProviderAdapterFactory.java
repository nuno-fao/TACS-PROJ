 ...
 * @generated
 */
public class CVItemProviderAdapterFactory extends CVAdapterFactory
	...
	public void dispose() {
		...
		if (bibliographicEntryItemProvider != null)
			bibliographicEntryItemProvider.dispose();
		if (tableItemProvider != null)
			tableItemProvider.dispose();
		if (tableRowItemProvider != null)
			tableRowItemProvider.dispose();
		if (personalDataItemProvider != null)
			personalDataItemProvider.dispose();
		if (contactsItemProvider != null)
			contactsItemProvider.dispose();
		if (educationItemProvider != null)
			educationItemProvider.dispose();
		if (jobEntryItemProvider != null)
			jobEntryItemProvider.dispose();
		if (educationEntryItemProvider != null)
			educationEntryItemProvider.dispose();
		if (workExperienceItemProvider != null)
			workExperienceItemProvider.dispose();
		if (skillsItemProvider != null)
			skillsItemProvider.dispose();
		if (skillEntryItemProvider != null)
			skillEntryItemProvider.dispose();
	}
