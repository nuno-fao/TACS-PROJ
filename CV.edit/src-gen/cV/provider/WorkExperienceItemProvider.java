 ...
 * @generated
 */
public class WorkExperienceItemProvider extends SectionItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CVPackage.Literals.WORK_EXPERIENCE__JOB_ENTRIES);
		}
	...
	public String getText(Object object) {
		String label = ((WorkExperience) object).getHeader();
		return label == null || label.length() == 0 ? getString("_UI_WorkExperience_type")
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(CVPackage.Literals.WORK_EXPERIENCE__JOB_ENTRIES,
