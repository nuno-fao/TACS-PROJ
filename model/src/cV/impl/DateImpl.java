...
public class DateImpl extends ItemImpl implements Date {
	...
	public void setStart_date(java.util.Date newStart_date) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CVPackage.DATE__START_DATE, oldStart_date, start_date));
	}
	...
	public void setEnding_date(java.util.Date newEnding_date) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CVPackage.DATE__ENDING_DATE, oldEnding_date, ending_date));
	}
