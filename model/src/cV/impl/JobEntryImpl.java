...
public class JobEntryImpl extends ItemImpl implements JobEntry {
	...
	public void setEmployer(String newEmployer) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CVPackage.JOB_ENTRY__EMPLOYER, oldEmployer, employer));
	}
	...
	public Date getDate() {
		if (date != null && date.eIsProxy()) {
			...
			if (date != oldDate) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CVPackage.JOB_ENTRY__DATE, oldDate, date));
			}
		}
		return date;
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CVPackage.JOB_ENTRY__DESCRIPTION, oldDescription, description));
	}
