...
public class BibliographicEntryImpl extends ItemImpl implements BibliographicEntry {
	...
	public void setAuthor(String newAuthor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CVPackage.BIBLIOGRAPHIC_ENTRY__AUTHOR, oldAuthor, author));
	}
	...
	public void setTitle(String newTitle) {
		...
		title = newTitle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CVPackage.BIBLIOGRAPHIC_ENTRY__TITLE, oldTitle, title));
	}
