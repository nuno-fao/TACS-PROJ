...
public class ContactsImpl extends SectionImpl implements Contacts {
		...
		if (address != null && address.eIsProxy()) {
			...
			if (address != oldAddress) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CVPackage.CONTACTS__ADDRESS, oldAddress, address));
			}
		}
		return address;
	}
	...
	public Text getPhone() {
		if (phone != null && phone.eIsProxy()) {
			...
			if (phone != oldPhone) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CVPackage.CONTACTS__PHONE, oldPhone, phone));
			}
		}
		return phone;
	}
	...
	public Text getEmail() {
		if (email != null && email.eIsProxy()) {
			...
			if (email != oldEmail) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CVPackage.CONTACTS__EMAIL, oldEmail, email));
			}
		}
		return email;
	}
