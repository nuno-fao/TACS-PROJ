 ...
 *        annotation="http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot rows_same_length_as_header='self.header-&gt;size() = 1 implies self.rows-&gt;forAll(r | r.items-&gt;size() = self.header-&gt;size())'"
 * @generated
 */
