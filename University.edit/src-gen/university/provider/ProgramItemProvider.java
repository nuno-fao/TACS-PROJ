...
/**
 * This is the item provider adapter for a {@link university.Program} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProgramItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						UniversityPackage.Literals.PROGRAM__NAME, true, false, false,
	...
	protected void addDurationPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Program_duration_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Program_duration_feature",
								"_UI_Program_type"),
						UniversityPackage.Literals.PROGRAM__DURATION, true, false, false,
	...
	protected void addDegreePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Program_degree_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Program_degree_feature",
								"_UI_Program_type"),
						UniversityPackage.Literals.PROGRAM__DEGREE, true, false, true, null, null, null));
	}
	...
	protected void addCoursesPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Program_courses_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Program_courses_feature",
								"_UI_Program_type"),
						UniversityPackage.Literals.PROGRAM__COURSES, true, false, true, null, null, null));
	}
